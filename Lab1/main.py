...
def main():
    ...
    run(Graphs, MSTs_Weights_Prim, MSTs_Weights_Kruskal, MSTs_Weights_Kruscal_Efficient, run_times_Prim, run_times_Kruskal, run_times_Kruskal_Efficient, True)
...
def run(Graphs, MSTs_Weights_Prim, MSTs_Weights_Kruskal, MSTs_Weights_Kruscal_Efficient, run_times_Prim, run_times_Kruskal, run_times_Kruskal_Efficient, Multiprocess = True):
    ...
    if Multiprocess == False:
        ...
        measureTime(Graphs, algorithms.Kruskal, MSTs_Weights_Kruskal, run_times_Kruskal) # Graphs[:50] requires 4 hours to compute
        ...
        Kruskal_process_3 = Process(target=measureTime, args=(Graphs[53:60], algorithms.Kruskal, MSTs_Weights_Kruskal_3, run_times_Kruskal_3))
        Kruskal_process_4 = Process(target=measureTime, args=(Graphs[60:65], algorithms.Kruskal, MSTs_Weights_Kruskal_4, run_times_Kruskal_4))
        Kruskal_process_5 = Process(target=measureTime, args=(Graphs[65:], algorithms.Kruskal, MSTs_Weights_Kruskal_5, run_times_Kruskal_5))
        ...
        process = [Prim_process, Kruskal_process_1, Kruskal_process_2, Kruskal_process_3, Kruskal_process_4, Kruskal_process_5, Kruskal_Efficient_process]
    ...
    for i in range(len(Graphs)):
        saving_data_Kruskal_Eff.append((run_times_Kruskal_Efficient[i], MSTs_Weights_Kruscal_Efficient[i]))
