...
def increaseKey() -> None:
    ...
    print("node", 3, "current weight", 300, "expected weight", 400)
    v.increaseKey(node=3, weightToAdd=100)
    print("node", [3, 4], "current weight", 100, "expected weight", 300)
    v.increaseKey(node=4, weightToAdd=200)
    print(v.all())
